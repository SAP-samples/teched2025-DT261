...
> * ZDT261_**0##**_EXT → **01** → **40** → **SAP TechEd Berlin**  (e.g ``ZDT261_019_EXT``)
...
<table>
  ...
  <tr>
    ...
    <td>ZDT261_### <br><i>Don't forget to replace all occurences of the placeholder ### with your assigned location and group number in the exercise steps below.</i></td>
  </tr>
</table>
