...
> * ZDT261_### → **001** → **040** → **SAP TechEd Berlin**
> * ZDT261_### → **100** → **199** → **ASUG Tech-Connect**
...
> For your convenience the generated RAP BO `ZDT261R_ShopTP_###` that has been prepared for your convenience supports the extensibility of the data model.  
